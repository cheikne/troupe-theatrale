...
public class Invoice implements TroupeTheatrale{
  ...
  public final String FOOTER = "<p><strong>Payement is required under 30 days. We can break your knees if you don't do so.</strong></p>";
  ...
  public String toHTML(Invoice invoice, Map<String, Play> plays){
    ...
    result.append("</tbody></table>").append(FOOTER).append("</div></html>");
  ...
  public double getTotalAmount() { return objectProxy.getTotalAmount();}
  ...
  public String toTEXT(double value,NumberFormat frmt){
